...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'yashkagawale@gmail.com',
    phone: '+91 12345 67899',
    address: {
      line1: 'yash kagawale',
      line2: 'abhyudaya nagar, mumbai'
    },
    gender: 'Male',
    dob: '2003-03-03'
  })
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
...

      {
        isEdit
          ...
          : <p className='font-meduim text-3xl text-neutral-800 mt-4'>{userData.name}</p>
      }
      ...
      <div className="">
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 met-3 text-neutral-700'>
