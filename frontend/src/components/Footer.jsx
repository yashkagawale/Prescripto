...
const socialLinks = [
  {
    ...
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"  className='text-indigo-500'>
  ...
  return (
    <div className='md:mx-10'>
        <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-10 text-sm">
            {/*-----------Left Side-----------*/}
            <div>
                <img onClick={() => {navigate('/'); scrollTo(0,0)}} className='mb-5 w-40 cursor-pointer' src={assets.logo} alt="Logo" />
